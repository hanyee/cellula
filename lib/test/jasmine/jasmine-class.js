describe("Cellula.Class", function () {
    ...
    beforeEach(function () {
        ...
        SubClassA = new Cellula.Class('SubClassA'+count,'NEW').inherits(SomeClass);
        SubClassB = new Cellula.Class('SubClassB'+count).inherits(SomeClass);
    ...
    describe('array attribute', function () {
        ...
        it("parent key changed - change property in array", function () {
            ...
            expect(sc2.arr).toEqual([2,3,4,'sc2']);
            expect(a.arr).toEqual([2,3,4]);
            expect(b.arr).toEqual([2,3,4]);
        });
    ...
    describe('undefined attribute', function () {
        it("origin unProp", function () {
            ...
            expect(sc2.unProp).toBe(undefined);
    ...
    describe('function attribute', function () {
        ...
        it("parent func changed", function () {
            ...
            sc2.func = function(){return 'sc2'};
            expect(sc.func()).toBe('sc');
            expect(sc2.func()).toBe('sc2');
            expect(a.func()).toBe('func');
            expect(b.func()).toBe('func');
        });
    ...
    describe('Class Reflection', function () {
        it("string case", function () {
            var TempClass = Cellula.Class.classFromString('SomeClass'+count);
            var temp = new TempClass;
            expect(sc instanceof TempClass).toBe(true);
            expect(sc2 instanceof TempClass).toBe(true);
            expect(temp instanceof SomeClass).toBe(true);
        });

        it("instace._class case", function () {
            var TempClass = Cellula.Class.classFromString(sc._class());
            var temp = new TempClass;
            expect(sc instanceof TempClass).toBe(true);
            expect(sc2 instanceof TempClass).toBe(true);
            expect(temp instanceof SomeClass).toBe(true);
