...
/*
                // to provide it with custom events. You may bind with `on` or remove with `off` callback functions
...
*/
            ...
            } //else{delete this.constructor.__initializing__;}
        };
        ...
        _class.extend = function(func){ // func should be a `function`
            if(typeof func === 'function') extend = func;
            return this;
        };
    ...
    //global.Class.create = function(){ return this.apply(this, arguments);};
