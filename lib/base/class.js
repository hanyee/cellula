...
(function(global){
    ...
    global.Class = function(className, classStruct){
        ...
        var idCounter = 0, __ancestor__ = '', _args = arguments;
...
//        _class.prototype.__className__ = CLASS_NAME;
        ...
        _class.inherits = function(parent){
            ...
            if(typeof parent === 'function' && _class.prototype._class.toString() === _getClass.toString()){
