TestCase("utilTest", {
    ...
    * */
    ...
    "test isEmptyObject": function() {
        assertTrue('{} is a emptyobject', Cellula._util.isEmptyObject({}));
        assertTrue('{"key":"value"} is a emptyobject', !Cellula._util.isEmptyObject({"key":"value"}));
    },

    "test getFirstPropName": function() {
        var obj = {};
        assertEquals('obj\'s first propName is undefined',Cellula._util.getFirstPropName(obj), undefined);

        obj = {one: 1, two: 2};
        assertEquals('obj\'s first propName is one',Cellula._util.getFirstPropName(obj), 'one');
    },
