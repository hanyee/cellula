...
//        };
    ...
    function __get__ (data, prop) { // returns all elements by default, prop is optional,
        ...
        if (util.isArray(prop)) return util.map(prop, function (v) { return data[v];});
    }
    ...
    cellula.Element = new cellula.Class('Element', {
        ...
        init : function (cfg) {
            ...
            //this.save = util.bind(this.save, this);
        },
