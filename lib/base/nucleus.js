/**
 * @fileOverview Cellula Framework's nucleus definition.
 * @description: defines nucleus
 * @namespace: Cellula
 * @version: 0.3.1
 * @author: @hanyee
 */
...
(function(cellula){
    ...
    cellula.Nucleus = new cellula.Class('Element', {
        key : '',
        _data : {},
        _isValidated : false,
        silent : false,
        ...
        init : function (cfg) {
            this._initCfg(cfg);
            if(!(cfg.silent || this.silent)) this.save();
        },
