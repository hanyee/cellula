...
(function(util){
    ...
    var keys = util.keys = nativeKeys || function (obj) {
    ...
    var map = util.map = function (obj, iterator, context) {
        var results = [];
        if (obj == null) return results;
        if (nativeMap && nativeMap === obj.map) return obj.map(iterator, context);
 ...
 /*
    ...
    */
    ...
    var bind = util.bind = function (func, context) {
        var bound, args;
        if (nativeBind && nativeBind === func.bind) return nativeBind.call(func);
